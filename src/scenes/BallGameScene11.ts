...
export default class BallGameScene11 extends Phaser.Scene{
    ...
    private rewOposCreat1?: Phaser.Physics.Arcade.Image;
    ...
    private squareInvent3?: Phaser.Physics.Arcade.Image;
    private reqtOposInvent2?: Phaser.Physics.Arcade.Image;
    ...
    create(){
        ...
        this.levelText = this.add.text(16, 16, 'level: 10', { fontSize: '32px', fill: '#000' });
        ...
        this.physics.add.collider(this.ballPlayer, this.reqtOposInvent2);
        this.physics.add.collider(this.ballPlayer, this.squareInvent3);
        this.physics.add.collider(this.ballPlayer, this.rewOposCreat1);
    }
    ...
    private createInvent(){
        ...
        this.squareInvent3 = this.physics.add.image(250, 550, 'square');
        this.squareInvent3?.setInteractive();
        this.squareInvent3?.setImmovable(true);
        this.squareInvent3.body.allowGravity = false;

        this.reqtOposInvent2 = this.physics.add.image(200, 550, 'leftRect');
        this.reqtOposInvent2?.setInteractive();
        this.reqtOposInvent2?.setImmovable(true);
        this.reqtOposInvent2.body.allowGravity = false;
    ...
    private createSquare (){
        ...
        loop1: for(let c = 0; c < this.squareInfo.count.col; c++){
            loop: for( let r = 0; r<this.squareInfo.count.row; r++){
                ...
                if(c === 4 && r === 0){
                    ...
                    let squareX = (c* this.squareInfo.width + this.squareInfo.offset.left);
                    let squareY = (r* this.squareInfo.height + this.squareInfo.offset.top);
                    this.rewOposCreat1 = this.physics.add.image(squareX, squareY, 'rewOpos');
                    this.rewOposCreat1.setImmovable(true);
                    this.rewOposCreat1.body.allowGravity = false;
                } else {
                    let squareX = (c* this.squareInfo.width + this.squareInfo.offset.left);
                    let squareY = (r* this.squareInfo.height + this.squareInfo.offset.top);
