...
export default class BallGameScene7 extends Phaser.Scene{
    ...
    create(){
        ...
        this.levelText = this.add.text(16, 16, 'level: 6', { fontSize: '32px', fill: '#000' });
    ...
    private createInvent(){
        ...
        this.rightRectInvent = this.physics.add.image(200, 550, 'rightRect');
    ...
    update () {
        ...
        if(this.newScene){
            this.scene.start("BallGameScene8");
        }
