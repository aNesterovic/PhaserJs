...
export default class BallGameScene9 extends Phaser.Scene{
    ...
    create(){
        ...
        this.levelText = this.add.text(16, 16, 'level: 8', { fontSize: '32px', fill: '#000' });
    ...
    private createInvent(){
        ...
        this.squareInvent3 = this.physics.add.image(200, 550, 'square');
    ...
    update () {
        ...
        if(this.newScene){
            this.scene.start("BallGameScene10");
        }
