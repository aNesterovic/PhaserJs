...
export default class BallGameScene3 extends Phaser.Scene{
    ...
    create(){
        ...
        this.levelText = this.add.text(16, 16, 'level: 3', { fontSize: '32px', fill: '#000' });
    ...
    update () {
        ...
        if(this.newScene){
            this.scene.start("BallGameScene4");
        }
