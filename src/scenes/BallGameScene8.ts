...
export default class BallGameScene8 extends Phaser.Scene{
    ...
    public rightRectInvent?: Phaser.Physics.Arcade.Image;
    private levelText?: Phaser.GameObjects.Text;
    private reqtOposInvent1?:Phaser.Physics.Arcade.Image;
    ...
    create(){
        ...
        this.levelText = this.add.text(16, 16, 'level: 7', { fontSize: '32px', fill: '#000' });
        ...
        this.physics.add.collider(this.ballPlayer, this.reqtOposInvent1);
    }
    ...
    private createInvent(){
        ...
        this.reqtOposInvent1 = this.physics.add.image(200, 550, 'leftRect');
        this.reqtOposInvent1?.setInteractive();
        this.reqtOposInvent1?.setImmovable(true);
        this.reqtOposInvent1.body.allowGravity = false;
    ...
    update () {
        ...
        if(this.newScene){
            this.scene.start("BallGameScene9");
        }
